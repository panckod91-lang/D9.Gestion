...
function showView(name) {
  ...
  $("#btnMore").classList.toggle("active",["cheques","maestros","clientes","ofertas","publicidad","config"].includes(name));
  const labels={home:"Gestión",pedidos:"Pedidos",operaciones:"Comprobantes",cuentas:"Cuentas corrientes",recibos:"Recibos",cheques:"Cheques",maestros:"Productos y precios",clientes:"Clientes",ofertas:"Productos en oferta",publicidad:"Publicidad",config:"Configuración"};
