...
const state = {
  ...
  gestion: {operaciones:[],items:[],recibos:[],pagos:[],cheques:[],movimientos:[],comisiones_reglas:[],config:{}},
  currentView:"home",
  draftItems:[],
  clientSearchResults:[],
  clientSearchIndex:0,
...
function applyBootstrap(data) {
  ...
  state.gestion={
    operaciones:data.gestion?.operaciones||[], items:data.gestion?.items||[], recibos:data.gestion?.recibos||[], pagos:data.gestion?.pagos||[], cheques:data.gestion?.cheques||[], movimientos:data.gestion?.movimientos||[], comisiones_reglas:data.gestion?.comisiones_reglas||[], config:data.gestion?.config||{}
  };
